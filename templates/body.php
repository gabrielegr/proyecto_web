	...
	<section class="full-width formated-section">
		<h2 class="text-center font-oswald">Como Reservas un Laboratorio</h2><br>
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					<center><img src="assets/img/Store.png" alt="Sucursal" class="img-responsive img-rounded"></center>
					<h3 class="text-center">Crea un usuario e inicia sesion</h3>
					<p class="text-center">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit possimus tempore sint impedit cum.
					</p>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<center><img src="assets/img/horario.png" width="90px" alt="Sucursal" class="img-responsive img-rounded"></center>
					<h3 class="text-center">Mira los laboratorios disponibles</h3>
					<p class="text-center">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit possimus tempore sint impedit cum.
					</p>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					<center><img src="assets/img/calendar.png" width="90px" alt="Sucursal" class="img-responsive img-rounded"></center>
					<h3 class="text-center">Elije la fecha que lo reservaras</h3>
					<p class="text-center">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit possimus tempore sint impedit cum.
					</p>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
					<center><img src="assets/img/check.png" width="160px" alt="Sucursal" class="img-responsive img-rounded"></center>
					<h3 class="text-center">Espera el mensaje de confirmacion</h3>
					<p class="text-center">
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit possimus tempore sint impedit cum.
					</p>
				</div>
